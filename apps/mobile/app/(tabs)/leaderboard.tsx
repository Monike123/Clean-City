...
export default function LeaderboardScreen() {
    ...
    useEffect(() => {
        ...
        realtimeService.subscribeToLeaderboardUpdates(() => {
            // When any profile updates (points change), reload the leaderboard
            // Simple strategy: instant reload. Can be optimized to debounce.
            console.log('Leaderboard update received, reloading...');
            loadLeaderboard();
        });

        return () => {
            realtimeService.unsubscribeLeaderboard();
        };
    }, []);
    ...
    const loadLeaderboard = async () => {
        try {
            // Try cache first
            const cacheKey = 'leaderboard_top20';
    ...
    return (
        <View className="flex-1 bg-background">
            ...
            <SafeAreaView className="flex-1" edges={['top']}>
                ...
                {/* List - Using ScrollView instead of FlatList */}
